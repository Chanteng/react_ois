  ...
  return (
    <>
      ...
      {/* <Container>
        <Row>
          <Col md="8">
            <h3 className="con-txt">
              <b>CONTACT ME</b>
            </h3>
            <hr />
            <h5>
              If you are interested in giving us some feedback, get in touch, we
              are giving our cheerful viewers to interact with us.
              <br />
              <p></p> We apologize in advance if we delay our responses. You can
              assured that we read each and every one of our email.
              <br />
              <br />
              <b><br />
                <p>
                  Mail Us:{" "}
                  <a
                    href="mailto:oismediagh@gmail.com"
                    style={{ textDecoration: "none" }}
                  >
                    oismediagh@gmail.com
                  </a>{" "}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </p>
              ...
              <br />
              For your require please feel free to contact me.
              <br />
              <br />
              <b>
                OIS_MEDIA...... #WE DO GENUINE BUSINESS
              </b>
            </h5>
            <br />
            <br />
          ...
          <Col md="4">
          <h6 className="soc-plug">SOCIAL PLUGIN</h6>
